...
def main():
    ...
    employee_password = os.getenv("EVALUATION_EMPLOYEE_PASSWORD") or os.getenv("DEMO_EMPLOYEE_PASSWORD")
    hr_password = os.getenv("EVALUATION_HR_PASSWORD") or os.getenv("DEMO_HR_PASSWORD")
    if not employee_password or not hr_password:
        parser.error("Set EVALUATION_EMPLOYEE_PASSWORD and EVALUATION_HR_PASSWORD to the existing account passwords.")
    checks = 0
