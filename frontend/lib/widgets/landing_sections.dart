                ...
                _Columns(
                  ...
                  children: const [
                    ...
                    _Benefit(
                      ...
                      accent: pink,
                      title: 'Маршрут вместе с OpenAI',
                      description:
                          'Career Copilot объясняет рекомендации и собирает '
                          'черновик маршрута из доступных мероприятий. Все факты, '
                          'лимиты и конфликты повторно проверяет сервер.',
                      tag: 'OPENAI CAREER COPILOT',
                    ),
                    _Benefit(
                      number: '05',
                ...
                children: [
                  ...
                  _Columns(
                    ...
                    children: const [
                      ...
                      _Step(
                        number: '03',
                        title: 'Собери маршрут с OpenAI',
                        description:
                            'Получи объяснённый черновик из реальных мероприятий, '
                            'проверь шаги и добавь подходящие в свой план.',
                        accent: pink,
                      ),
                    ],
                  ),
  ...
  Widget _faq(bool wide) {
    ...
    const questions = Column(
      children: [
        ...
        _Question(
          question: 'Что именно делает OpenAI?',
          answer:
              'Career Copilot понятным языком объясняет серверные расчёты и '
              'предлагает черновик маршрута только из доступных мероприятий. '
              'Он не меняет план сам, не оценивает сотрудника и не принимает '
              'решения о повышении. Если сервис недоступен, работает локальный алгоритм.',
        ),
        _Question(
        ...
        _Question(
          ...
          answer:
              'В профиле отдельно показаны последняя оценка и расчётный прирост '
              'после выполненных практик. Самоотчёт не меняет подтверждённую '
              'оценку навыка; для получения XP результат проверяет HR.',
        ),
        _Question(
